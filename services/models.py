...
class ServicePage(Page):
    ...
    def clean(self):
        ...
        if not self.internal_page and not self.external_page:
            raise ValidationError({
                'internal_page':ValidationError("Please set either an internal or external page"),
                'external_page':ValidationError("Please set either an internal or external page")
            })
